...
const createRestaurant = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield restaurant_service_1.restaurantService.createRestaurant(req.body);
...
const getAllFromDB = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield restaurant_service_1.restaurantService.getAllFromDB();
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
